...
function MyBiodata() {
   ...
   return (
     <div>
       ...
       <h1 className="my-auto text-2xl text-center">
         You have not added your biodata yet.
         <Link to={"/dashboard/edit-biodata"} className="font-bold text-pink-400 underline">Click here</Link> to Add you Biodata
       </h1>
     </div>
   );
 }
